                    ...
                    <div class="card-header bg-gradient text-white" id="gradient1">
                        <div class="form-row">
                            <div class="form-group col-md-2 mt-4">
                                <img src="{{asset('image/LogoNuha.png')}}" width="130" height="130" class="text-center ml-5">
                            </div>
                                ...
                                {{-- card wawancara anak --}}
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <label for="pertanyaan1" class="font">1. Tau sekolah Pondok Pesantren Nurul Huda dari mana ?</label>
                                                    <select id="pertanyaan1" type="text" class="form-control @error('pertanyaan1') is-invalid @enderror" name="pertanyaan1" value="{{ old('pertanyaan1') }}" required autocomplete="pertanyaan1" autofocus>
                                                        ...
                                                        <option value="Siswa SMK WIKRAMA">Santri Pondok Pesantren Nurul Huda</option>
                                                        <option value="Alumni SMK WIKRAMA">Alumni Pondok Pesantren Nurul Huda</option>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <label for="pertanyaan5" class="font">3. Kenapa Anda Memilih Pondok Pesantren Nurul Huda ?</label>
                                        ...
                                        <div class="card-body">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <label for="pertanyaan15" class="font">3. Kenapa Anda Memilih Pondok Pesantren Nurul Huda?</label>
                                                            <div class="form-group">
